...
// Initialize and configure SpeechKITT
SpeechKITT.setStartCommand(() => sr.start());
SpeechKITT.setAbortCommand(() => sr.stop());
sr.onstart = () => SpeechKITT.onStart();
sr.onend = () => SpeechKITT.onEnd();
